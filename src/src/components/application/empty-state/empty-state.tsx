...
import { FeaturedIcon as FeaturedIconbase } from "@/src/components/foundations/featured-icon/featured-icon";
import type { BackgroundPatternProps } from "@/src/components/shared-assets/background-patterns";
import { BackgroundPattern } from "@/src/components/shared-assets/background-patterns";
import { Illustration as Illustrations } from "@/src/components/shared-assets/illustrations";
