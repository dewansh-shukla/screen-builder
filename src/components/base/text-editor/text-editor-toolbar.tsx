...
export const TextEditorToolbar = ({ className, ref, type = "simple", floating = false, hideFontSize, hideColor, hideAlign }: TextEditorToolbarProps) => {
    if (type === "simple") {
        return (
            <div
                className={cx(
            ...
            >
                ...
                <div className="mx-1 px-1 py-1.5 self-stretch">
