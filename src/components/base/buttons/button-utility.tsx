...
export interface CommonProps {
    ...
    /** Accessible label for the button (used when tooltip is not provided) */
    "aria-label"?: string;
}
...
export const ButtonUtility = ({
    ...
    const content = (
        <Component
            aria-label={tooltip || otherProps["aria-label"]}
            {...props}
            className={cx(
        ...
        >
            ...
            {isValidElement(Icon) && cloneElement(Icon, { "data-icon": true })}
        </Component>
    );
