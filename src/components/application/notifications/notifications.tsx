...
export const IconNotification = ({
  ...
  return (
    <div className="bg-primary_alt ring-secondary_alt xs:w-[var(--width)] xs:flex-row relative z-[var(--z-index)] flex max-w-full flex-col gap-4 rounded-xl p-4 shadow-lg ring">
      <FeaturedIcon
