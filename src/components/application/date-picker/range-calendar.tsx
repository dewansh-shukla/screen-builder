  ...
  return (
    <ContextWrapper>
      ...
      >
            ...
            <AriaCalendarGridHeader>
              {day => (
                <AriaCalendarHeaderCell className="border-b-4 border-transparent p-0">
                  <div className="text-secondary flex size-10 items-center justify-center text-sm font-medium">
                    {day.slice(0, 2)}
                  </div>
        ...
        {isDesktop && (
          <div className="border-secondary flex flex-col gap-3 border-l px-6 py-5">
