...
// Source: /Users/dewanshshukla/Desktop/zapigo/zapigowebclient/src/components/DateTimePicker.tsx
// Last synced: 2026-03-17T11:17:26.985Z
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        IconLeft: () => <ChevronLeft className="h-4 w-4 bg-white" />,
        IconRight: () => <ChevronRight className="h-4 w-4 bg-white" />,
        Caption: ({ displayMonth }) => {
          return (
            <div className="inline-flex gap-2">
              ...
              >
                <SelectTrigger className="w-fit gap-1 border-none bg-white p-0">
    ...
    return (
      <div className="flex h-10 items-center">
        ...
        >
          ...
          <SelectContent>
            <SelectItem value="AM" className="bg-white">
              AM
            </SelectItem>
            <SelectItem value="PM" className="bg-white">
              PM
            </SelectItem>
          </SelectContent>
        </Select>
  ...
  (
    ...
    return (
      <Input
        ...
        name={name || picker}
        className={cn(
          'w-[48px] text-center font-mono text-base tabular-nums [&::-webkit-inner-spin-button]:appearance-none',
          className,
        )}
    ...
    return (
      <Popover>
        ...
        <PopoverContent className="w-auto bg-white p-0">
          ...
          />
          {granularity !== 'day' && (
            <div className="border-border border-t bg-white p-3">
              <TimePicker
                onChange={value => {
                  onChange?.(value);
                  setDisplayDate(value);
